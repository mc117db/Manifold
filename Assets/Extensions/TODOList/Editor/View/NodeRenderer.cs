...
public class NodeRenderer  {
	...
	public const int SMALL_NODE_HIGHT  = 25;
	public const int LARGEL_NODE_HIGHT = 40;
	...
	public static void renderNode(TNode node, int index, Rect position) {
		...
		if(TCore.size == TODOListSize.SMALL) {
			ww = position.width - 150f;
		}

		GUILayout.BeginArea(new Rect (15, index * m - d, ww, 50), ""); {
			GUIStyle s;
